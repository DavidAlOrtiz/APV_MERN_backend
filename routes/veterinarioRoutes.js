...
import { registrar, perfil, confirmar, autenticar, olvidepasword, comprobarToken, nuevoPassword, 
    back, restore, impotaDatos,exportD, actualizarPeril, actualizarPass  } from '../controllers/veterinarioController.js'
...
router.put("/perfil/:id", chekAuth, actualizarPeril)
...
router.put("/actualizarPassword", chekAuth, actualizarPass)
